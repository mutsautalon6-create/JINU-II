...
global.channelLink = "https://whatsapp.com/channel/0029VbAhyS28aKvMWmEiHt1M";
global.ytch = "GLADDYTECH";
...
if (userMessage.startsWith('.')) {
    const lightBlue = chalk.hex('#00CFFF');

    console.log(lightBlue(`╭──〔 📝 Command Log 〕──`));
    console.log(lightBlue(`│`));
    console.log(lightBlue(`├─ Source: ${isGroup? 'Group': 'Private'}`));
    console.log(lightBlue(`├─ Message: ${userMessage}`));
    console.log(lightBlue(`│`));
    console.log(lightBlue(`╰──〔 ⚙️ Powered By JINU-II 〕──`));
}
...
async function handleGroupParticipantUpdate(sock, update) {
    try {
        ...
        if (action === 'remove') {
            ...
            const channelId = goodbyeData?.channelId || '+120363422020175323@newsletter';
